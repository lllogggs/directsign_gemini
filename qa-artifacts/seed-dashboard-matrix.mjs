...
const types = [
  {
    ...
    displayType: "sponsor",
    typeSlug: "sponsor",
    campaignTitle: "루트코스메틱 수분크림 인스타 릴스 협찬",
    platform: "INSTAGRAM",
  ...
  },
  {
    ...
    displayType: "PPL",
    typeSlug: "ppl",
    campaignTitle: "테크베어 스마트 모니터 유튜브 리뷰 건",
    platform: "YOUTUBE",
  ...
  },
  {
    ...
    typeSlug: "groupbuy",
    campaignTitle: "네오슈즈 신발 2종 공동구매 진행",
    platform: "NAVER_BLOG",
...
function buildContract(typeInfo, stage, advertiserId) {
  ...
  return {
    ...
    campaign_name: `[${batch}] ${typeInfo.campaignTitle}`,
    advertiser_info: { name: companyName, manager: advertiserName },
    type: typeInfo.type,
    status: stage.status,
    title: `[${batch}] ${typeInfo.campaignTitle} - ${stage.label}`,
    influencer_info: {
      name: influencerName,
