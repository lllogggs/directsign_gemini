...
export const SCREEN_HELP_CONTENT = {
  advertiserDashboard: {
    ...
    primaryAction:
      "서명 대기와 콘텐츠 검수 계약을 먼저 열어 마감 전에 다음 행동을 처리하세요.",
    flow: [
      "계약 생성",
      "서명 링크 공유",
      "PDF 원문 확인",
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "서명 대기와 콘텐츠 검수 계약을 먼저 열어 캠페인 마감 전에 막힌 지점을 처리합니다.",
      },
      {
        title: "계약 행에서 상세로 이동",
        description:
          "인플루언서, 금액, 기간을 확인한 뒤 계약 상세에서 서명 링크와 콘텐츠 제출·검수 상태를 처리합니다.",
      },
    ],
    safeguards: [
  ...
  contractAdmin: {
    ...
    title: "계약 상세 도움말",
    summary:
      "최종 계약서, 서명 링크, 전자서명과 PDF 증빙 상태를 관리하는 화면입니다.",
    primaryAction:
      "최종 계약서를 확인한 뒤 서명 링크를 만들고 서명 상태를 확인하세요.",
    flow: [
      "최종 계약서 확인",
      "서명 링크 만들기",
      "PDF 원문 확인",
    ...
    steps: [
      ...
      },
      {
        title: "최종 계약서 확인",
        description:
          "메시지센터에서 합의한 금액, 기간, 콘텐츠 조건이 최종 계약서에 정확히 반영됐는지 확인합니다.",
      },
      {
        title: "서명 가능 상태 만들기",
        description:
          "광고주 인증이 완료되면 서명 링크를 만들고 인플루언서에게 계약서 PDF 확인과 서명을 요청합니다.",
      },
    ],
    safeguards: [
  ...
  influencerContract: {
    ...
    title: "계약 검토 도움말",
    summary:
      "광고주가 보낸 1:1 계약의 핵심 조건과 PDF 원문을 확인하고 전자서명하는 화면입니다.",
    primaryAction:
      "계약서 PDF를 확인한 뒤 서명하세요. 변경이 필요하면 서명 전에 메시지센터에서 광고주와 먼저 합의하세요.",
    flow: [
      "핵심 조건 확인",
      "PDF 원문 확인",
      "변경 필요 시 메시지 합의",
    ...
    steps: [
      ...
      },
      {
        title: "PDF 원문 확인",
        description:
          "게시 매체, 업로드 기한, 수정 가능 횟수, 지급 조건, 광고 표시 의무가 실제 합의와 같은지 확인합니다.",
      },
      {
        title: "변경이 필요하면 먼저 합의",
        description:
          "서명하지 말고 메시지센터에서 광고주와 합의한 뒤, 변경 내용이 반영된 새 최종본과 서명 링크를 확인합니다.",
      },
    ],
    safeguards: [
      "서명은 최종 계약서 전체에 동의했다는 증빙으로 남습니다.",
      "이해되지 않는 내용이 있으면 서명하지 말고 메시지센터에서 먼저 확인하세요.",
      "계정 인증이 필요한 계약은 인증 승인 후 서명할 수 있습니다.",
    ],
    completion:
      "PDF 원문 확인, 계정 인증, 전자서명이 끝나면 서명본 PDF가 생성되어 계약 증빙으로 남습니다.",
  },
