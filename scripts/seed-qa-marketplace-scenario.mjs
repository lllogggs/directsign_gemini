...
const buildCampaigns = (advertiser) => [
  {
    ...
    type: "sponsored_post",
    budget: "150만-250만원",
    applicantLimit: `${4 + advertiser.number}명`,
  ...
  },
  {
    ...
    budget: "제품 제공 + 80만원",
    applicantLimit: `${3 + (advertiser.number % 3)}명`,
    summary: "제품을 직접 사용한 뒤 피드와 블로그에 상세 리뷰를 남기는 캠페인입니다.",
    deadline: addDays(12 + advertiser.number),
    platforms: ["instagram", "naver_blog"],
    deliverables: ["피드 게시물 1건", "네이버 블로그 리뷰 1건"],
    status: "open",
    createdAt: addDays(-4),
    updatedAt: timestamp,
    statusUpdatedAt: timestamp,
  ...
  },
  {
    ...
    budget: "200만-320만원",
    applicantLimit: `${2 + (advertiser.number % 2)}명`,
